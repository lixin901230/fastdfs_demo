...
public class FileUtils {
	...
	public static void main(String[] args) {
		...
		String name1 = "M00_00_00_wKgAllfVgn-EW1h9AAAAAAAAAAA319_part-20.zip";
		boolean matches1 = name1.toLowerCase().matches("M00_00_00_wKgAllfVgn-EW1h9AAAAAAAAAAA319".toLowerCase()+"_part-[0-9]*.zip");
		System.out.println(matches1);
		String name = "M00_00_00_wKgAllfVgn-EW1h9AAAAAAAAAAA319.zip_segment-20.part";
		boolean matches = name.toLowerCase().matches(".*_segment-".toLowerCase()+"[0-9]+.part");
	...
	public static List<File> getDirFiles(String dirPath, final String fileSegmentFlag, final String fileExtName) {
		...
		File[] fileArr = file.listFiles(new FilenameFilter() {
			...
			public boolean accept(File dir, String name) {
				...
				//正则匹配文件名，如：String name = "M00_00_00_wKgAllfVgn-EW1h9AAAAAAAAAAA319.zip_segment-20.part";
